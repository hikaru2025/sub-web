...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "whatsup233.vercel.app (自动编译最新版本后端-测试）": "https://whatsup233.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://whatsup233.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://whatsup233.vercel.app/sub?";
